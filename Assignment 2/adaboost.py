...
Original file is located at
    https://colab.research.google.com/drive/1L34kvQcv2w3YrLzIwomoMXtn1Zwo7EGB
"""
...
def weighted_majority(h, z, x):
  ...
  # votes = sum(z_k * h_k.predict(x) for h_k, z_k in zip(h, z))
  return (votes>0 ).astype(int)

h,z=AdaBoost(train_x,train_y,logistic_regression,10, seed=42)
